    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-darker flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-primary-light/30 dark:bg-primary/20 rounded-full blur-[120px] transition-colors" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-blue-400/20 dark:bg-blue-600/10 rounded-full blur-[120px] transition-colors" />
            </div>
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="glass-panel p-8 md:p-10 border-slate-200 dark:border-white/10 bg-white/70 dark:bg-black/20 backdrop-blur-xl shadow-xl dark:shadow-none transition-all">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 transition-colors">Welcome Back</h2>
                        <p className="text-slate-500 dark:text-slate-400 transition-colors">Sign in to access your portfolio</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <a href="#" className="text-sm text-primary-dark dark:text-primary hover:text-primary dark:hover:text-primary-glow transition-colors font-medium">Forgot password?</a>
                            </div>
                            <input
                                type="password"
                                value={password}
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 dark:text-slate-400 text-sm transition-colors">
                            ...
                            <Link to="/register" className="text-primary-dark dark:text-primary hover:text-primary dark:hover:text-primary-glow font-medium transition-colors">
                                Create account
                            </Link>
                        </p>
                    </div>
